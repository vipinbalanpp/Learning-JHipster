...
import { deleteEntity, getEntity } from './owner.reducer';
...
export const OwnerDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="demoApp.owner.delete.question">Are you sure you want to delete Owner {ownerEntity.id}?</ModalBody>
      <ModalFooter>
